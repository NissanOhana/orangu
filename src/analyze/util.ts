...
export function fmtTokens(n: number): string {
  ...
  // 999,995,000+ would round to "1000.00M": hand it to the B tier as well
  if (n >= 1e9 || (n >= 1_000_000 && Number((n / 1_000_000).toFixed(2)) >= 1000)) return (n / 1e9).toFixed(n >= 1e10 ? 0 : 1) + 'B'
