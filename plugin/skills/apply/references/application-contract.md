...
- This receipt is a skill-authored attestation of the files changed and checks run. Orangu validates its schema and exact agreement with the reviewed relative file list; it does not inspect the working-tree diff, independently run a command, or prove filesystem confinement.
